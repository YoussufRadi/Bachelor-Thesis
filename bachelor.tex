...
\newcommand{\titleOfThesisOne}{Life Span Recorder and Memory Visualization}

\newcommand{\authorOfThesis}{Youssuf Radi}
\newcommand{\supervisorOne}{Prof. Dr. Dirk Reichardt}
\newcommand{\supervisorTwo}{M.Sc. Ahmed Elnaggar}
